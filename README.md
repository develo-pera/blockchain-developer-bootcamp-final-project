...
4. Installing dependencies and running client:
    ...
    - Get address of a DCommerce contract from your local Ganache blockchain and paste it to `client/src/statis/DCommerceContract.js` file as a `[ChainId.Localhost]` property
    - Get address of a Store contract from your local Ganache blockchain and paste it to `client/src/statis/StoreContract.js` file as a `[ChainId.Localhost]` property
    - Run `yarn start`
