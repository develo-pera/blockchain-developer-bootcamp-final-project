...
const Redeem = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <button onClick={onButtonClick} className={styles.redeemButton}>{isApproved ? (waitingForRedeemTransaction ? "Redeeming..." : "Redeem") : (waitingForTransaction ? "Approving..." : "Approve")}</button>
    </div>
  )
};
